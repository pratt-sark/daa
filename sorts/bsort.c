...
//Implementation of Bubble Sort (iterative) 
//Program: 18
...
int main() 
{ 
	printf("\n\n___________This program implements BUBBLE SORT (Iterative approach)__________\n\n");
...
{ 
	...
	/**loop which effectively reduces the boundary of the next pass of bubble sort
	Logic: The inner loop ('j' loop) can have a max value of < n-i-1.
	As 'i' increments, the boundary of the next bubble sort pass shrinks. */
    for (i=0; i<n-1; i++)	 
	{
