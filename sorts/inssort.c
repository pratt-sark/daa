...
//Implementation of Insertion Sort (iterative)
//Program: 20
...
void insertionSort(int *arr, int n, char sign);

int main() 
{ 
    printf("\n\n___________This program implements INSERTION SORT (Iterative approach)__________\n\n");
...
void insertionSort(int *arr, int n, char sign)
{
    ...
    //Start from index 1, which is the 2nd index
    for (i=1; i<n; i++) 
    {
        key = arr[i]; //set value of key
        j = i-1; //set an index less than that of key
