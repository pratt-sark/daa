...
//Addition of Matrices (Divide and conquer)
//Program: 4
...
void main()
{
    printf("\n This program is an implementation of Matrix Addition using Divide and Conquer Algorithm.\n");
    ...
    */ 
    ...
    int max=(m>=n)?m:n; //calculate max of row limit and column limit
    ...
    printf("\nAfter Matrix Addition (A+B), the resultant Matrix 'C' : \n");
    display(C,m,n); 
}
...
//function to add matrices using Divide and Conquer algorithm
int** adddnc(int **X,int **Y,int n)
{
    int** Z = allocatemem(n);
    //base case
    ...
    else
    {
        ...
        Z11 = adddnc(X11,Y11,k);
        Z12 = adddnc(X12,Y12,k);
        Z21 = adddnc(X21,Y21,k);
        Z22 = adddnc(X22,Y22,k);
